...
void efftest()
{
  ...
  crecoMat->SaveAs("efftestPlots/crecoMat.pdf");
  ...
  creco->SaveAs("efftestPlots/creco.pdf");
  ...
  cgen->SaveAs("efftestPlots/cgen.pdf");
  ...
  ceff->SaveAs("efftestPlots/ceff.pdf");
  ...
  craw->SaveAs("efftestPlots/craw.pdf");
  ...
  ccorr->SaveAs("efftestPlots/ccorr.pdf");
}
