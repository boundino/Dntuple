...
TString mvatk = "(Dtrk1highPurity&&Dtrk2highPurity)&&(Dmass>1.75&&Dmass<1.95)";//highpurity
...
void triggerturnonFast()
{
 ...
 // infname = "/data/wangj/Data2015/Dntuple/ntD_HiForest_262163-262165_300k.root";
  ...
  TH1D* hpp_pt_HltDpt15 = getYield(root,"&&HLT_DmesonPPTrackingGlobal_Dpt8_v1","_HLT_DmesonPPTrackingGlobal_Dpt8_v1","HLT_DmesonPPTrackingGlobal_Dpt8_v1_Prescl","Dpt","pt","p_{T} (GeV/c)",16,0,80);
  plotTurnOn(hpp_pt_HltDpt15,hpp_pt,"HLT_DmesonPPTrackingGlobal_Dpt8_v1","_HLT_DmesonPPTrackingGlobal_Dpt8_v1","pt","p_{T} (GeV/c)",16,0,80);
