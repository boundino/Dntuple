...
//  else infname = Form("/export/d00/scratch/jwang/Dmeson/ntD_20151110_DfinderMC_20151110_EvtMatching_Pyquen_D0tokaonpion_D0pt%.0fp0_Pthat%.0f_TuneZ2_Unquenched_5020GeV_GENSIM_75x_v2_20151110_50k_L1v4_v15_loosecuts_MBseed_1108.root",pthat,pthat);
  if(!isPbPb) infname = Form("/afs/cern.ch/work/w/wangj/public/Dmeson/ntD_20151115_DfinderMC_20151115_EvtMatching_Pythia_D0pt%.0fp0_Pthat%.0f_TuneZ2_5020GeV_GENSIM_75x_1015_20151110_ppGlobaTrackingPPmenuHFlowpuv11_MBseed_twang-Pythia_755patch2_v20_MBseed_1116.root",pthat,pthat);
  else infname = Form("/afs/cern.ch/work/w/wangj/public/Dmeson/ntD_20151110_DfinderMC_20151110_EvtMatching_Pyquen_D0tokaonpion_D0pt%.0fp0_Pthat%.0f_TuneZ2_Unquenched_5020GeV_GENSIM_75x_v2_20151110_50k_L1v4_v15_loosecuts_MBseed_1108.root",pthat,pthat);
  ...
  TFile *outf = new TFile(Form("triggerturnon_%.0f.root",pthat),"recreate");

  if(!isPbPb)
    {
      plotTurnOn(root,"HLT_DmesonPPTrackingGlobal_Dpt8_v1", "Dpt","pt","p_{T} (GeV/c)",NBIN,BINMIN,BINMAX);
      plotTurnOn(root,"HLT_DmesonPPTrackingGlobal_Dpt15_v1","Dpt","pt","p_{T} (GeV/c)",NBIN,BINMIN,BINMAX);
      plotTurnOn(root,"HLT_DmesonPPTrackingGlobal_Dpt20_v1","Dpt","pt","p_{T} (GeV/c)",NBIN,BINMIN,BINMAX);
      plotTurnOn(root,"HLT_DmesonPPTrackingGlobal_Dpt30_v1","Dpt","pt","p_{T} (GeV/c)",NBIN,BINMIN,BINMAX);
      plotTurnOn(root,"HLT_DmesonPPTrackingGlobal_Dpt40_v1","Dpt","pt","p_{T} (GeV/c)",NBIN,BINMIN,BINMAX);
      plotTurnOn(root,"HLT_DmesonPPTrackingGlobal_Dpt50_v1","Dpt","pt","p_{T} (GeV/c)",NBIN,BINMIN,BINMAX);
      plotTurnOn(root,"HLT_DmesonPPTrackingGlobal_Dpt60_v1","Dpt","pt","p_{T} (GeV/c)",NBIN,BINMIN,BINMAX);
	  /*
...
//      else chinclusive->SaveAs(Form("triggerturnonPlots/pthat%.0f/MBseed/pp/chinclusive_%s.pdf",pthat,varname.Data()));
      if(isPbPb) chinclusive->SaveAs(Form("triggerturnonPlots/mc/pbpb/pthat%.0f/chinclusive_%s.pdf",pthat,varname.Data()));
      else chinclusive->SaveAs(Form("triggerturnonPlots/mc/pp/pthat%.0f/chinclusive_%s.pdf",pthat,varname.Data()));
    }
  ...
  */
  ...
  if(isPbPb) cMBseed->SaveAs(Form("triggerturnonPlots/mc/pbpb/pthat%.0f/c%s_MBseed_%s.pdf",pthat,triggerpass.Data(),varname.Data()));
  else cMBseed->SaveAs(Form("triggerturnonPlots/mc/pp/pthat%.0f/c%s_MBseed_%s.pdf",pthat,triggerpass.Data(),varname.Data()));
}
  ...
  if(isPbPb)
    {
      ...
      cpbpbL1seed->SaveAs(Form("triggerturnonPlots/mc/pbpb/pthat%.0f/L1seed/c%s_L1seed.pdf",pthat,triggerpass.Data()));
    }
  else
    {
      ...
      cppL1seed->SaveAs(Form("triggerturnonPlots/mc/pbpb/pthat%.0f/L1seed/c%s_L1seed.pdf",pthat,triggerpass.Data()));
    }
}
