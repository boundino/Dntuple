...
TF1* bFeedDownFractionPbPb(Float_t ptMin=20, Float_t ptMax=40)
{
  ...
  TFile* infData = new TFile("/data/dmeson2015/DataDntuple/nt_skimmed_DfinderData_PbPb_20160126_dPt0tkPt2p5_D0Dstar3p5p_FINALJSON_v6_partialstats_v2_skimmed.root");
   ...
   TLegend* legcomp = new TLegend(0.54,0.64,0.90,0.88,NULL,"brNDC");
   legcomp->SetBorderSize(0);
   legcomp->SetTextSize(0.04);
   legcomp->SetTextFont(42);
   legcomp->SetFillStyle(0);
   legcomp->AddEntry(hData,"Data signal reg","pl");
   legcomp->AddEntry(hSideband,"Data sideband","f");
   legcomp->AddEntry(hMCPSignal,"MC Prompt","f");
