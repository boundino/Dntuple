...
public:
    ...
    double  tktkRes_svpvDistance[MAX_XB];
    double  tktkRes_svpvDisErr[MAX_XB];
	double  tktkRes_alpha[MAX_XB];
    ...
    void regTree(TTree *root, bool detailMode = false){//{{{
        ...
        root->Branch("DInfo.tktkRes_svpvDistance"  , tktkRes_svpvDistance      , "DInfo.tktkRes_svpvDistance[DInfo.size]/D"	);
        root->Branch("DInfo.tktkRes_svpvDisErr"    , tktkRes_svpvDisErr        , "DInfo.tktkRes_svpvDisErr[DInfo.size]/D"	);
		root->Branch("DInfo.tktkRes_alpha"         , tktkRes_alpha             , "DInfo.tktkRes_alpha[DInfo.size]/D" );
