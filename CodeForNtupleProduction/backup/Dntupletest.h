...
{//{{{
 public:
  ...
  void buildDBranch(TTree* dnt)
  {
    ...
    dnt->Branch("Dgenslowtk",Dgenslowtk,"Dgenslowtk[Dsize]/I");
  }
            ...
            for(int j=0;j<DInfo->size;j++)
              {
                if(skim)
                  {
                    if(DInfo->tktkRes_pt[j]<8.&&(DInfo->tktkRes_svpvDistance[j]/DInfo->tktkRes_svpvDisErr[j])<4.) continue;
                  }
                if(DInfo->type[j]==(t+1))
                  {
        ...
        if(DInfo->type[j]==1||DInfo->type[j]==2)
        ...
        else if(DInfo->type[j]==11||DInfo->type[j]==12)
          {
            if(DInfo->tktkRes_rftk1_index[j]>-1 && DInfo->tktkRes_rftk2_index[j]>-1 && DInfo->tktkRes_rftk3_index[j]>-1 && DInfo->tktkRes_rftk4_index[j]>-1)
              {
                if(TrackInfo->pt[DInfo->tktkRes_rftk1_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk2_index[j]] &&
                   TrackInfo->pt[DInfo->tktkRes_rftk1_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk3_index[j]] &&
                   TrackInfo->pt[DInfo->tktkRes_rftk1_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk4_index[j]] &&
                   TrackInfo->pt[DInfo->tktkRes_rftk1_index[j]]<=TrackInfo->pt[DInfo->rftk2_index[j]]) Dgenslowtk[typesize]=1;
                if(TrackInfo->pt[DInfo->tktkRes_rftk2_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk1_index[j]] &&
                   TrackInfo->pt[DInfo->tktkRes_rftk2_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk3_index[j]] &&
                   TrackInfo->pt[DInfo->tktkRes_rftk2_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk4_index[j]] &&
                   TrackInfo->pt[DInfo->tktkRes_rftk2_index[j]]<=TrackInfo->pt[DInfo->rftk2_index[j]]) Dgenslowtk[typesize]=2;
                if(TrackInfo->pt[DInfo->tktkRes_rftk3_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk1_index[j]] &&
                   TrackInfo->pt[DInfo->tktkRes_rftk3_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk2_index[j]] &&
                   TrackInfo->pt[DInfo->tktkRes_rftk3_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk4_index[j]] &&
                   TrackInfo->pt[DInfo->tktkRes_rftk3_index[j]]<=TrackInfo->pt[DInfo->rftk2_index[j]]) Dgenslowtk[typesize]=3;
                if(TrackInfo->pt[DInfo->tktkRes_rftk4_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk1_index[j]] &&
                   TrackInfo->pt[DInfo->tktkRes_rftk4_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk2_index[j]] &&
                   TrackInfo->pt[DInfo->tktkRes_rftk4_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk3_index[j]] &&
                   TrackInfo->pt[DInfo->tktkRes_rftk4_index[j]]<=TrackInfo->pt[DInfo->rftk2_index[j]]) Dgenslowtk[typesize]=4;
                if(TrackInfo->pt[DInfo->rftk2_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk1_index[j]] &&
                   TrackInfo->pt[DInfo->rftk2_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk2_index[j]] &&
                   TrackInfo->pt[DInfo->rftk2_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk3_index[j]] &&
                   TrackInfo->pt[DInfo->rftk2_index[j]]<=TrackInfo->pt[DInfo->tktkRes_rftk4_index[j]]) Dgenslowtk[typesize]=5;
                ...
                if(TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]>-1)
                  {
                    Dgen[typesize]+=10;//10
                    if(GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]]>-1)
                      {
                        if(TMath::Abs(GenInfo->pdgId[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]]])==RpdgId)
                          {
                            if(GenInfo->mo1[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]]]>-1)
                              {
                                if(TMath::Abs(GenInfo->pdgId[GenInfo->mo1[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]]]])==DpdgId)
                                  {
                                    Dgen[typesize]+=10;//20
                                  }
                              }
                ...
                if(TrackInfo->geninfo_index[DInfo->tktkRes_rftk3_index[j]]>-1)
                  {
                    Dgen[typesize]+=100;//100
                    if(GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk3_index[j]]]>-1)
                      {
                        if(TMath::Abs(GenInfo->pdgId[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk3_index[j]]]])==RpdgId)
                          {
                            if(GenInfo->mo1[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk3_index[j]]]]>-1)
                              {
                                if(TMath::Abs(GenInfo->pdgId[GenInfo->mo1[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk3_index[j]]]]])==DpdgId)
                                  {
                                    Dgen[typesize]+=100;//200
                                  }
                              }
                          }
                      }
                  }
                if(TrackInfo->geninfo_index[DInfo->tktkRes_rftk4_index[j]]>-1)
                  {
                    Dgen[typesize]+=1000;//1000
                    if(GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk4_index[j]]]>-1)
                      {
                        if(TMath::Abs(GenInfo->pdgId[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk4_index[j]]]])==RpdgId)
                          {
                            if(GenInfo->mo1[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk4_index[j]]]]>-1)
                              {
                                if(TMath::Abs(GenInfo->pdgId[GenInfo->mo1[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk4_index[j]]]]])==DpdgId)
                                  {
                                    Dgen[typesize]+=1000;//2000
                                  }
                              }
                          }
                      }
                  }
                if(Dgen[typesize]==2222)
                  {
                    if(GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]]==GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]] &&
                           ...
                           TMath::Abs(GenInfo->pdgId[TrackInfo->geninfo_index[DInfo->tktkRes_rftk4_index[j]]])==findPdgid(DInfo->tktkRes_rftk4_mass[j]))
                          {
                            ...
                            dGenIdxRes = GenInfo->mo1[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]]];
                                ...
                                (TMath::Abs(GenInfo->pdgId[TrackInfo->geninfo_index[DInfo->tktkRes_rftk3_index[j]]])==findPdgid(DInfo->tktkRes_rftk4_mass[j]) && 
                                 ...
                                 TMath::Abs(GenInfo->pdgId[TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]])==PION_PDGID))
                          {
                            Dgen[typesize]+=1122;//3344
                            dGenIdxRes = GenInfo->mo1[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]]];
                          }
                      }
                  }
                else if(Dgen[typesize]==2220||Dgen[typesize]==2202||Dgen[typesize]==2022||Dgen[typesize]==222||
                        Dgen[typesize]==2221||Dgen[typesize]==2212||Dgen[typesize]==2122||Dgen[typesize]==1222)
                  {
                    if(Dgen[typesize]==2220||Dgen[typesize]==2221)
                      {
                        if(GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]]==GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk3_index[j]]] &&
                           GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]]==GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk4_index[j]]])
                          {
                            if(TMath::Abs(GenInfo->pdgId[TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]])==findPdgid(DInfo->tktkRes_rftk2_mass[j]) &&
                               TMath::Abs(GenInfo->pdgId[TrackInfo->geninfo_index[DInfo->tktkRes_rftk3_index[j]]])==findPdgid(DInfo->tktkRes_rftk3_mass[j]) &&
                               TMath::Abs(GenInfo->pdgId[TrackInfo->geninfo_index[DInfo->tktkRes_rftk4_index[j]]])==findPdgid(DInfo->tktkRes_rftk4_mass[j]))
                              {
                                Dgen[typesize]+=1110;//3330,3331
                                dGenIdxRes = GenInfo->mo1[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]]];
                              }
                          }
                      }
                    if(Dgen[typesize]==2202||Dgen[typesize]==2212)
                      {
                        if(GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]]==GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk3_index[j]]] &&
                           GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]]==GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk4_index[j]]])
                          {
                            if(TMath::Abs(GenInfo->pdgId[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]])==findPdgid(DInfo->tktkRes_rftk1_mass[j]) &&
                               TMath::Abs(GenInfo->pdgId[TrackInfo->geninfo_index[DInfo->tktkRes_rftk3_index[j]]])==findPdgid(DInfo->tktkRes_rftk3_mass[j]) &&
                               TMath::Abs(GenInfo->pdgId[TrackInfo->geninfo_index[DInfo->tktkRes_rftk4_index[j]]])==findPdgid(DInfo->tktkRes_rftk4_mass[j]))
                              {
                                Dgen[typesize]+=1101;//3303,3313
                                dGenIdxRes = GenInfo->mo1[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]]];
                              }
                          }
                      }
                    if(Dgen[typesize]==2022||Dgen[typesize]==2122)
                      {
                        if(GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]]==GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]] &&
                           GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]]==GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk4_index[j]]])
                          {
                            if(TMath::Abs(GenInfo->pdgId[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]])==findPdgid(DInfo->tktkRes_rftk1_mass[j]) &&
                               ...
                               TMath::Abs(GenInfo->pdgId[TrackInfo->geninfo_index[DInfo->tktkRes_rftk4_index[j]]])==findPdgid(DInfo->tktkRes_rftk4_mass[j]))
                              {
                                Dgen[typesize]+=1011;//3033,3133
                                dGenIdxRes = GenInfo->mo1[GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]]];
                              }
                          }
                      }
                    if(Dgen[typesize]==222||Dgen[typesize]==1222)
                      {
                        if(GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]]==GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk2_index[j]]] &&
                           GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk1_index[j]]]==GenInfo->mo1[TrackInfo->geninfo_index[DInfo->tktkRes_rftk3_index[j]]])
                          {
