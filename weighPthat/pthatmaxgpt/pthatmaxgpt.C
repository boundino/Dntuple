...
void pthatmaxgpt(Float_t samplePthat=0, Bool_t toPlot=false)
{
  const int nBins=6; Double_t ptBins[nBins+1]={0.,5.,10.,15.,30.,50.,100.};
  TFile* inf = new TFile(Form("/data/wangj/MC2015/Dntuple/pp/ntD_pp_Dzero_kpi/ntD_EvtBase_20160125_Dfinder_20151229_pp_Pythia8_prompt_D0pt%.0fp0_Pthat%.0f_TuneCUETP8M1_5020GeV_evtgen130_GEN_SIM_20151212_dPt1tkPt1_D0Ds.root",samplePthat,samplePthat));
