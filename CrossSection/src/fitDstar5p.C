...
void fitDstar5p(TString inputdata="/data/wangj/Data2015/Dntuple/pp/ntD_EvtBase_20160104_DfinderData_pp_20151218_dPt0tkPt1_D0Dstar3p5p.root", 
              TString inputmc="/data/wangj/MC2015/Dntuple/pp/ntD_pp_Dstar_D0kpipipi/ntD_EvtBase_20151231_Dfinder_20151229_pp_Pythia8D0kpipipi_noweight.root", 
              TString trgselection="1",  
              TString cut="(Dy>-1.0&&Dy<1.0&&Dpt>1.&&Dtrk1Pt>1.&&DRestrk1Pt>1.&&DRestrk2Pt>1.) && (DtktkRes_chi2cl>0.047&&DtktkRes_alpha<0.033&&(DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>3.44)", 
              ...
              TString outputfile="../outputfiles/output.root")
{
  ...
  TTree* nt = (TTree*)inf->Get("ntDD0kpipipipi");
...
int main(int argc, char *argv[])
{
  ...
  if(argc == 11)
    fitDstar5p(argv[1], argv[2], argv[3], argv[4], argv[5], atoi(argv[6]), atof(argv[7]), atoi(argv[8]),argv[9],argv[10]);
  return 0;
}
