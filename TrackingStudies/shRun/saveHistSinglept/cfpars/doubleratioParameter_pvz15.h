...
TString infnameData3p[SPE_NUM] = {"/data/wangj/MC2015/Dntuple/pp/ntD_pp_Dstar_D0kpi/ntD_EvtBase_20160203_Dfinder_20160201_pp_Pythia8D0kpi_dPt0tkPt0p5_pthatweight.root",
				  ...
				  "/mnt/hadoop/cms/store/user/jwang/DntupleRun2/pp_MinimumBias_Run2015E_PromptReco_v1_AOD/ntD_EvtBase_20160219_Dfinder_20160219_pp_MinimumBias_Run2015E_PromptReco_v1_AOD_dPt2tkPt0p5_Dstar3p5p_skim_20160308_MB1to10.root"};
...
TString prefilter3p[SPE_NUM] = {"Dtrk1Pt>0.5&&DRestrk1Pt>0.5&&DRestrk2Pt>0.5&&(((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>4.&&DtktkRespt<8.)||((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>1.5&&DtktkRespt>8.))&&abs(DtktkResmass-1.86486)<0.05",
                                ...
                                "Dtrk1Pt>0.5&&DRestrk1Pt>0.5&&DRestrk2Pt>0.5&&(((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>3.&&DtktkRespt<8.)||((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>1.5&&DtktkRespt>8.))&&abs(DtktkResmass-1.86486)<0.025&&TMath::Abs(PVz)<15.",
                                "Dtrk1Pt>0.5&&DRestrk1Pt>0.5&&DRestrk2Pt>0.5&&(((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>3.&&DtktkRespt<8.)||((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>1.5&&DtktkRespt>8.))&&abs(DtktkResmass-1.86486)<0.025&&TMath::Abs(PVz)<15."};
TString prefilter5p[SPE_NUM] = {"Dtrk1Pt>0.5&&DRestrk1Pt>0.5&&DRestrk2Pt>0.5&&DRestrk3Pt>0.5&&DRestrk4Pt>0.5&&(((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>4.&&DtktkRespt<8.)||((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>1.5&&DtktkRespt>8.))&&abs(DtktkResmass-1.86486)<0.05",
                                ...
                                "Dtrk1Pt>0.5&&DRestrk1Pt>0.5&&DRestrk2Pt>0.5&&DRestrk3Pt>0.5&&DRestrk4Pt>0.5&&(((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>3.&&DtktkRespt<8.)||((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>1.5&&DtktkRespt>8.))&&abs(DtktkResmass-1.86486)<0.01&&TMath::Abs(PVz)<15.",
                                "Dtrk1Pt>0.5&&DRestrk1Pt>0.5&&DRestrk2Pt>0.5&&DRestrk3Pt>0.5&&DRestrk4Pt>0.5&&(((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>3.&&DtktkRespt<8.)||((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>1.5&&DtktkRespt>8.))&&abs(DtktkResmass-1.86486)<0.01&&TMath::Abs(PVz)<15."};
