...
TString prefilter3p[SPE_NUM] = {"Dtrk1Pt>0.5&&DRestrk1Pt>0.5&&DRestrk2Pt>0.5&&(((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>4.&&DtktkRespt<8.)||((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>1.5&&DtktkRespt>8.))&&abs(DtktkResmass-1.86486)<0.05",
                                ...
                                "Dtrk1Pt>0.5&&DRestrk1Pt>0.5&&DRestrk2Pt>0.5&&(((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>3.&&DtktkRespt<8.)||((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>1.5&&DtktkRespt>8.))&&abs(DtktkResmass-1.86486)<0.025&&TMath::Abs(Dtrk1Eta)<1.&&TMath::Abs(DRestrk1Eta)<1.&&TMath::Abs(DRestrk2Eta)<1.",
                                "Dtrk1Pt>0.5&&DRestrk1Pt>0.5&&DRestrk2Pt>0.5&&(((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>3.&&DtktkRespt<8.)||((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>1.5&&DtktkRespt>8.))&&abs(DtktkResmass-1.86486)<0.025&&TMath::Abs(Dtrk1Eta)<1.&&TMath::Abs(DRestrk1Eta)<1.&&TMath::Abs(DRestrk2Eta)<1."};
TString prefilter5p[SPE_NUM] = {"Dtrk1Pt>0.5&&DRestrk1Pt>0.5&&DRestrk2Pt>0.5&&DRestrk3Pt>0.5&&DRestrk4Pt>0.5&&(((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>4.&&DtktkRespt<8.)||((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>1.5&&DtktkRespt>8.))&&abs(DtktkResmass-1.86486)<0.05",
                                ...
                                "Dtrk1Pt>0.5&&DRestrk1Pt>0.5&&DRestrk2Pt>0.5&&DRestrk3Pt>0.5&&DRestrk4Pt>0.5&&(((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>3.&&DtktkRespt<8.)||((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>1.5&&DtktkRespt>8.))&&abs(DtktkResmass-1.86486)<0.01&&TMath::Abs(Dtrk1Eta)<1.&&TMath::Abs(DRestrk1Eta)<1.&&TMath::Abs(DRestrk2Eta)<1.&&TMath::Abs(DRestrk3Eta)<1.&&TMath::Abs(DRestrk4Eta)<1.",
                                "Dtrk1Pt>0.5&&DRestrk1Pt>0.5&&DRestrk2Pt>0.5&&DRestrk3Pt>0.5&&DRestrk4Pt>0.5&&(((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>3.&&DtktkRespt<8.)||((DtktkRes_svpvDistance/DtktkRes_svpvDisErr)>1.5&&DtktkRespt>8.))&&abs(DtktkResmass-1.86486)<0.01&&TMath::Abs(Dtrk1Eta)<1.&&TMath::Abs(DRestrk1Eta)<1.&&TMath::Abs(DRestrk2Eta)<1.&&TMath::Abs(DRestrk3Eta)<1.&&TMath::Abs(DRestrk4Eta)<1."};
