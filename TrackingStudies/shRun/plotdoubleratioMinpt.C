...
int plotdoubleratioMinpt(TString condition="default")
{ 
  ...
  TString outputfilename3pMC = Form("outputfiles/output_pp_%s_3p_MC.root",condition.Data());
  TString outputfilename3pDa = Form("outputfiles/output_pp_%s_3p_Data.root",condition.Data());
  TString outputfilename5pMC = Form("outputfiles/output_pp_%s_5p_MC.root",condition.Data());
  TString outputfilename5pDa = Form("outputfiles/output_pp_%s_5p_Data.root",condition.Data());
  ...
  hempty->Draw();
  gRatio->Draw("psame");
  cRatio->SaveAs(Form("plots/Ratio/cRatio_%s.pdf",condition.Data()));
  ...
  hemptyTrkEff->Draw();
  gTrkEff->Draw("psame");
  cTrkEff->SaveAs(Form("plots/Ratio/cTrkEff_%s.pdf",condition.Data()));
